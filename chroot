...
read -r userName userPassword rootPassword hostName dualBoot timeZone reflectorCode diskName diskShred customConfig archURL nvme processorVendor cpuThreads graphicsVendor < /confidentials
